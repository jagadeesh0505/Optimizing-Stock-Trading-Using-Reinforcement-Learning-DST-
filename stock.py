...
def plot_train_test(train, test, date_split):
    ...
    iplot(figure)
st.write(plot_train_test(train,test, date_split))
...
st.write(Q, total_losses, total_rewards = train_dqn(Environment1(train)))
...
def plot_loss_reward(total_losses, total_rewards):
    ...
    figure['layout']['xaxis1'].update(title='NI')
    figure['layout']['xaxis2'].update(title='NI')
    figure['layout'].update(height=400, width=900, showlegend=False)
    iplot(figure)

st.write(plot_loss_reward(total_losses, total_rewards))
...
st.write(plot_train_test_by_q(Environment1(train), Environment1(test), Q, 'DQN'))